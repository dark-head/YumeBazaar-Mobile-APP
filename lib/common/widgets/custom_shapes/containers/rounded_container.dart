...
class YbRoundedContainer extends StatelessWidget {
  ...
  const YbRoundedContainer({
    ...
    this.padding = const EdgeInsets.all(YbSizes.md),
    this.borderColor = YbColors.borderPrimary,
    this.radius = YbSizes.cardRadiusLg,
    this.backgroundColor = YbColors.white,
  });
