...
class YbAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: YbSizes.md),
      child: AppBar(
        automaticallyImplyLeading: false,
        leading: showBackArrow
            ? IconButton(onPressed: () => Get.back(), icon: Icon(Iconsax.arrow_square_left5, color: dark ? YbColors.white : YbColors.dark))
            : leadingIcon != null
  ...
  @override
  Size get preferredSize => Size.fromHeight(YbDeviceUtils.geYbAppBarHeight());
}
