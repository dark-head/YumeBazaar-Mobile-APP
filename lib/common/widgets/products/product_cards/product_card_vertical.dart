...
class YbProductCardVertical extends StatelessWidget {
  const YbProductCardVertical({super.key, required this.product, this.isNetworkImage = true});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          boxShadow: [YbShadowStyle.verticalProductShadow],
          borderRadius: BorderRadius.circular(YbSizes.productImageRadius),
          color: dark ? YbColors.darkerGrey : YbColors.white,
        ),
        child: Column(
          ...
          children: [
            ...
            YbRoundedContainer(
              ...
              backgroundColor: dark ? YbColors.dark : YbColors.light,
              child: Stack(
                children: [
                  /// -- Thumbnail Image
                  Center(child: YbRoundedImage(imageUrl: product.thumbnail, applyImageRadius: true, isNetworkImage: isNetworkImage)),
                  ...
                  if (salePercentage != null)
                    Positioned(
                      ...
                      child: YbRoundedContainer(
                        radius: YbSizes.sm,
                        backgroundColor: YbColors.secondary.withOpacity(0.8),
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  YbProductTitleText(title: product.title, smallSize: true),
                  const SizedBox(height: YbSizes.spaceBtwItems / 2),
