...
class YbProductCardHorizontal extends StatelessWidget {
  const YbProductCardHorizontal({super.key, required this.product, this.isNetworkImage = true});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: YbHelperFunctions.isDarkMode(context) ? YbColors.darkerGrey : YbColors.lightContainer,
        ),
        child: Row(
          ...
          children: [
            ...
            YbRoundedContainer(
              ...
              backgroundColor: isDark ? YbColors.dark : YbColors.light,
              child: Stack(
                children: [
                  /// -- Thumbnail Image
                  YbRoundedImage(width: 120, height: 120, imageUrl: product.thumbnail, isNetworkImage: isNetworkImage),
                  ...
                  if (salePercentage != null)
                    Positioned(
                      ...
                      child: YbRoundedContainer(
                        backgroundColor: isDark ? YbColors.secondary.withOpacity(0.8) : YbColors.secondary.withOpacity(0.8),
                        radius: YbSizes.sm,
                  ...
                  Positioned(
                    top: 0,
                    right: 0,
                    child: YbFavouriteIcon(productId: product.id),
                  ),
                ],
              ),
            ),
            ...
            Container(
              padding: const EdgeInsets.only(left: YbSizes.sm),
              width: 172,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  /// -- Details
                  Padding(
                    padding: const EdgeInsets.only(top: YbSizes.sm),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        YbProductTitleText(
                        ...
                        const SizedBox(height: YbSizes.spaceBtwItems / 2),
                        YbBrandTitleWithVerifiedIcon(title: product.brand!.name, brandTextSize: TextSize.small),
                      ],
                    ),
                  ),
                      ...
                      Flexible(
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.only(left: YbSizes.sm),
                              child: YbProductPriceText(price: ProductController.instance.getProductPrice(product)),
                            ),
                          ],
                        ),
                      ),
