...
class YbCartCounterIcon extends StatelessWidget {
  const YbCartCounterIcon({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        //   right: 0,
        //   child: Container(
        //     width: YbSizes.fontSizeLg,
        //     height: YbSizes.fontSizeLg,
        //     decoration: BoxDecoration(
        //       color: counterBgColor ?? (dark ? YbColors.white : YbColors.black),
        ...
        //                 color: counterTextColor ?? (dark ? YbColors.black : YbColors.white),
        //                 fontSizeFactor: 0.8,
        //               ),
        //         ),
        //       ),
        ...
        //   ),
        // ),
        Image.asset('assets/logos/YB_LOGO_FINAL__.png')
      ],
    );
  }
}
