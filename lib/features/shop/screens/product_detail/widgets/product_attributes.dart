          ...
          if (controller.selectedVariation.value.id.isNotEmpty)
            Column(
              ...
              children: [
                Row(
                  children: [
                    const YbSectionHeading(title: 'Variation: ', showActionButton: false),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const YbProductTitleText(title: 'Price : ', smallSize: true),
          ...
          Column(
            ...
            children: product.productAttributes!
                .map((attribute) => Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        YbSectionHeading(title: attribute.name ?? '', showActionButton: false),
