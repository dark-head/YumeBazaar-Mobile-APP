...
class AllProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: YbAppBar(title: Text(title), showBackArrow: true),
        ...
        child: Padding(
          ...
          child: FutureBuilder(
            ...
            builder: (_, snapshot) {
              ...
              return YbSortableProductList(products: products);
            },
          ),
        ),
      ),
...
class YbSortableProductList extends StatelessWidget {
  const YbSortableProductList({
    super.key,
