            ...
            children: [
              ...
              FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  final response = YbCloudHelperFunctions.checkMultiRecordState(snapshot: snapshot, loader: const YbVerticalProductShimmer());
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      YbGridLayout(
                        ...
                        itemBuilder: (_, index) => YbProductCardVertical(product: products[index], isNetworkImage: true),
                      ),
                    ],
                  );
                },
