...
class YbHeaderCategories extends StatelessWidget {
  /// Constructor for [YbHeaderCategories].
  const YbHeaderCategories({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.only(left: YbSizes.defaultSpace),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          /// -- Heading
          const YbSectionHeading(title: 'Popular Categories', textColor: YbColors.white, showActionButton: false),
          ...
          Obx(
            () {
              ...
              if (categoryController.isLoading.value) return const YbCategoryShimmer();
