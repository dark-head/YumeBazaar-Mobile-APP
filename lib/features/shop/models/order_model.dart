...
class OrderModel {
  ...
  String get formattedOrderDate => YbHelperFunctions.getFormattedDate(orderDate);

  String get formattedDeliveryDate => deliveryDate != null ? YbHelperFunctions.getFormattedDate(deliveryDate!) : '';
