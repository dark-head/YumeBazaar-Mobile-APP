...
class AddressController extends GetxController {
  ...
  addNewAddresses() async {
    try {
      ...
      TFullScreenLoader.openLoadingDialog('Storing Address...', YbImages.docerAnimation);
    ...
    return showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            const YbSectionHeading(title: 'Select Address'),
            FutureBuilder(
            ...
            const SizedBox(height: YbSizes.defaultSpace * 2),
            SizedBox(
