...
class UserController extends GetxController {
  ...
  uploadUserProfilePicture() async {
    try {
      ...
      if (image != null) {
        ...
        YbLoaders.successSnackBar(title: 'Congratulations', message: 'Your Profile Image has been updated!');
      }
    } catch (e) {
      imageUploading.value = false;

      YbLoaders.errorSnackBar(title: 'OhSnap', message: 'Something went wrong: $e');
    }
  }
  ...
  void deleteAccountWarningPopup() {
    Get.defaultDialog(
      contentPadding: const EdgeInsets.all(YbSizes.md),
      ...
      confirm: ElevatedButton(
        ...
        child: const Padding(padding: EdgeInsets.symmetric(horizontal: YbSizes.lg), child: Text('Delete')),
      ),
  ...
  void deleteUserAccount() async {
    try {
      TFullScreenLoader.openLoadingDialog('Processing', YbImages.docerAnimation);
      ...
      YbLoaders.warningSnackBar(title: 'Oh Snap!', message: e.toString());
    }
  }
  ...
  logout() {
    try {
      Get.defaultDialog(
        ...
        confirm: ElevatedButton(
          child: const Padding(
            padding: EdgeInsets.symmetric(horizontal: YbSizes.lg),
            child: Text('Confirm'),
          ),
          onPressed: () async {
            onClose();
