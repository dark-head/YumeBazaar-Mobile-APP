...
class UploadDataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const YbAppBar(title: Text('Upload Data'), showBackArrow: true),
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  const YbSectionHeading(title: 'Main Record', showActionButton: false),
                  const SizedBox(height: YbSizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.category, size: 28, color: YbColors.primary),
                    title: Text('Upload Categories', style: Theme.of(context).textTheme.titleMedium),
                    trailing: IconButton(
                      onPressed: () => controller.uploadCategories(),
                      icon: const Icon(Iconsax.arrow_up_1, size: 28, color: YbColors.primary),
                    ),
                  ),
                  const SizedBox(height: YbSizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.shop, size: 28, color: YbColors.primary),
                  ...
                  const SizedBox(height: YbSizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.shopping_cart, size: 28, color: YbColors.primary),
                  ...
                  const SizedBox(height: YbSizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.image, size: 28, color: YbColors.primary),
                  ...
                  const YbSectionHeading(title: 'Relationships', showActionButton: false),
                  const Text('Make sure you have already uploaded all the content above.'),
                  const SizedBox(height: YbSizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.link, size: 28, color: YbColors.primary),
